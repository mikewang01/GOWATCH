...
const I8U ui_matrix_button[UI_DISPLAY_MAXIMUM] = {
	...
	// 2: a set of the typical use cases
        /*UI_DISPLAY_BLE_CODE*/              UI_DISPLAY_TRACKER_BATTERY,
        /*UI_DISPLAY_TRACKER_BALANCE,*/      UI_DISPLAY_BLE_CODE ,
	/*UI_DISPLAY_TRACKER_STEP,*/          UI_DISPLAY_TRACKER_DISTANCE,
	/*UI_DISPLAY_TRACKER_BATTERY,*/UI_DISPLAY_HOME,
	/*UI_DISPLAY_TRACKER_DISTANCE,*/UI_DISPLAY_TRACKER_CALORIES,
	/*UI_DISPLAY_TRACKER_CALORIES,*/UI_DISPLAY_TRACKER_BALANCE,
...
const I8U ui_matrix_finger_middle[UI_DISPLAY_MAXIMUM] = {
	...
	/*UI_DISPLAY_PAIRING,*/               UI_DISPLAY_PAIRING,
	// 2: a set of the typical use cases
	/*UI_DISPLAY_TRACKER_BALANCE,*/        UI_DISPLAY_TRACKER_BALANCE,
	/*UI_DISPLAY_TRACKER_STEP,*/          UI_DISPLAY_TRACKER_STEP,
	/*UI_DISPLAY_TRACKER_BATTERY,*/UI_DISPLAY_TRACKER_BATTERY,
...
const I8U ui_matrix_finger_right[UI_DISPLAY_MAXIMUM] = {
	...
	/*UI_DISPLAY_TRACKER_BATTERY,*/UI_DISPLAY_TRACKER_BATTERY,
	/*UI_DISPLAY_TRACKER_DISTANCE,*/UI_DISPLAY_TRACKER_CALORIES,
	/*UI_DISPLAY_TRACKER_CALORIES,*/UI_DISPLAY_SMART_WEATHER,
	// 3: a set of battery stats
...
const I8U ui_matrix_swipe_left[UI_DISPLAY_MAXIMUM] = {
	...
	/*UI_DISPLAY_PAIRING,*/UI_DISPLAY_PAIRING,
	// 2: a set of the typical use cases
	/*UI_DISPLAY_TRACKER_BALANCE,*/UI_DISPLAY_HOME,
	/*UI_DISPLAY_TRACKER_STEP,*/UI_DISPLAY_TRACKER_CALORIES,
	/*UI_DISPLAY_TRACKER_BATTERY,*/UI_DISPLAY_TRACKER_STEP,
	/*UI_DISPLAY_TRACKER_DISTANCE,*/UI_DISPLAY_TRACKER_BALANCE,
	...
	/*UI_DISPLAY_VITAL_SKIN_TEMP,*/UI_DISPLAY_TRACKER_BATTERY,
	// 5: Special back panel mode
	/*UI_DISPLAY_SETTING_VER,*/UI_DISPLAY_SETTING_VER,
	// 6: Confirmation messages
	/*UI_DISPLAY_STOPWATCH_START,*/ UI_DISPLAY_STOPWATCH_START,
...
const I8U ui_matrix_swipe_right[UI_DISPLAY_MAXIMUM] = {
	// 0: Home
	/* UI_DISPLAY_HOME */ UI_DISPLAY_TRACKER_BALANCE,
	// 1: System
	/*UI_DISPLAY_DARK,*/UI_DISPLAY_DARK,
	/*UI_DISPLAY_CLING,*/UI_DISPLAY_CLING,
	/*UI_DISPLAY_OTA,*/UI_DISPLAY_OTA,
	/*UI_DISPLAY_PAIRING,*/UI_DISPLAY_PAIRING,
	// 2: a set of the typical use cases
	/*UI_DISPLAY_TRACKER_BALANCE,*/UI_DISPLAY_TRACKER_DISTANCE,
	/*UI_DISPLAY_TRACKER_STEP,*/UI_DISPLAY_TRACKER_BATTERY,
	/*UI_DISPLAY_TRACKER_BATTERY,*/UI_DISPLAY_VITAL_SKIN_TEMP,
	/*UI_DISPLAY_TRACKER_DISTANCE,*/UI_DISPLAY_TRACKER_CALORIES,
...
const I8U ui_gesture_constrain[UI_DISPLAY_MAXIMUM] = {
	...
	// 2: a set of the typical use cases
	/*UI_DISPLAY_TRACKER_BALANCE,*/               S_F_BS_BH,
	/*UI_DISPLAY_TRACKER_STEP,*/                 S_F_BS_BH,
	/*UI_DISPLAY_TRACKER_BATTERY,*/                S_F_BS_BH,
