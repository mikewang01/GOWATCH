        ...
        #define FAT_CLING_APP_SPACE_SIZE                           (FAT_CLING_APP_PAGE_ALL*FLASH_ERASE_BLK_SIZE)
  ...
  // System linking cridentials
        ...
        #define SYSTEM_INFORMATION_SPACE_SIZE           (SYSTEM_INFORMATION_PAGE_SIZE*FLASH_ERASE_BLK_SIZE)
        ...
        #define SYSTEM_DAYSTAT_SPACE_SIZE                   (SYSTEM_DAYSTAT_PAGE_SIZE*FLASH_ERASE_BLK_SIZE)
        ...
        #define SYSTEM_SCRATCH_SPACE_SIZE                   (SYSTEM_SCRATCH_PAGE_SIZE*FLASH_ERASE_BLK_SIZE)
        //
        ...
        #define SYSTEM_TRACKING_SPACE_SIZE          (SYSTEM_TRACKING_PAGE_SIZE*FLASH_ERASE_BLK_SIZE)            // Minute activity SPACE - 28 KB
        ...
        #define SYSTEM_REMINDER_SPACE_SIZE                (SYSTEM_REMINDER_PAGE_SIZE*FLASH_ERASE_BLK_SIZE)
        ...
        #define SYSTEM_NOTIFICATION_SPACE_SIZE            (SYSTEM_NOTIFICATION_PAGE_SIZE*FLASH_ERASE_BLK_SIZE)

        #define FLASH_SIZE                      (FAT_FLASH_PAGE_ALL*FLASH_ERASE_BLK_SIZE) /* 256 KB */
