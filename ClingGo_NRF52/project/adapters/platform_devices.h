...
UART_BUS(UART1, SERIAL1, HW_UART_BAUDRATE_115200, HW_UART_DATABITS_8, HW_UART_PARITY_NONE,
         HW_UART_STOPBITS_1, 0, 1, HW_DMA_CHANNEL_1, HW_DMA_CHANNEL_0, 0, 0)
...
SPI_SLAVE_DEVICE(SPI1, ACC_SENSOR, 0, GPIO_SPI_0_CS_ACC,
        HW_SPI_WORD_8BIT, HW_SPI_POL_LOW, HW_SPI_PHA_MODE_0,
        HW_SPI_FREQ_8M, 0);
#endif

#if IS_SPI_FLASH_SUPPORTED
SPI_SLAVE_DEVICE(SPI1, FLASH, 0, GPIO_SPI_0_CS_NFLASH,
        HW_SPI_WORD_8BIT, HW_SPI_POL_LOW, HW_SPI_PHA_MODE_0,
        HW_SPI_FREQ_8M, 0);
#endif

#if IS_SPI_FM1280_SUPPORTED
SPI_SLAVE_DEVICE(SPI1, FM1280, 0, GPIO_SPI_0_CS_FM1280B,
        HW_SPI_WORD_8BIT, HW_SPI_POL_LOW, HW_SPI_PHA_MODE_1,
        HW_SPI_FREQ_8M, 0);
#endif


#if IS_SPI_OLED_SUPPORTED
SPI_SLAVE_DEVICE(SPI1, OLED, 0, (GPIO_SPI_0_CS_OLED),
        HW_SPI_WORD_8BIT, HW_SPI_POL_LOW, HW_SPI_PHA_MODE_0,
        HW_SPI_FREQ_8M, 0);
#endif
...
I2C_SLAVE_DEVICE(I2C1, I2C_OLED, I2C_OLED_ADDR, HW_I2C_ADDRESSING_7B, HW_I2C_SPEED_FAST);
//I2C_SLAVE_DEVICE_DMA(I2C1, I2C_OLED, I2C_OLED_ADDR, HW_I2C_ADDRESSING_7B, HW_I2C_SPEED_FAST, HW_DMA_CHANNEL_4);
#endif
