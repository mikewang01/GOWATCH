...
#define BLE_APP_NOTIFY_FSM_MASK (1 << 1)
#define BLE_APP_NOTIFY_MASK (1 << 0)
#define BLE_APP_NOTIFY_FSM_MASK (1 << 1)
#define BLE_APP_NOTIFY_CLING_PAY_MASK (1 << 2)
#define BLE_APP_NOTIFY_CLING_PAY_CMD_MASK (1 << 3)
#define BLE_APP_NOTIFY_CLING_PAY_BALANCE_MASK (1 << 4)
#define BLE_APP_NOTIFY_CLING_PAY_BALANCE_SYNC_MASK (1 << 5)
#define BLE_APP_NOTIFY_CLING_PAY_BALANCE_SYNC_TIMEOUT_MASK (1 << 6)
#define BLE_APP_NOTIFY_CLING_STRAT_ADV_REQUEST_MASK (1 << 7)
#define BLE_APP_NOTIFY_CLING_ADV_SWITCH_SPEED_REQUEST_MASK (1 << 8)
#define BLE_APP_NOTIFY_SOFT_DEVICE_MASK (1 << 9)
/** BLE error code */
typedef enum {
...
/**
 * ble_on_event_process_reg
 *
 * \ Return status code
 *
 * \param [in]     p   event process callback
 * \param [out]    int   >0 sucess
 *
 */
